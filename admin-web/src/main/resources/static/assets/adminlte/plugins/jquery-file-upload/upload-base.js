...
/*
 ...
 <div class="col-xs-8 control-label progress" style="display: none;margin-bottom: 0px;">
 <div class="progress-bar progress-bar-success">0</div>
 </div>
 <div class="col-xs-2 control-label showimg">
 </div>
 </div>
...
//                dataType: 'json', //如果不返回json数据，需要注释掉。
        ...
        progressall: function (e, data) {
            ...
            var md5str = data["md5"];
            if (imgwidth) {
                $("#" + id).find(".showimg").attr("imgwidth", imgwidth);
            }
            if (imgheight) {
                $("#" + id).find(".showimg").attr("imgheight", imgheight);
            }
            if (md5str) {
                $("#" + id).find(".showimg").attr("md5str", md5str);
            }
